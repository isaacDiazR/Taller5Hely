...
class TestE2ETaskLifecycle:
    ...
    def test_e2e_filtering_workflow(self, client):
        ...
        tasks_config = [
            ...
            {'title': 'Medium Priority Pending', 'priority': 'medium', 'complete': False}
        ]
    ...
    def test_e2e_stats_tracking(self, client):
        ...
        # Completar 2 tareas
        client.put('/api/tasks/1', data=json.dumps({'completed': True}), content_type='application/json')
        client.put('/api/tasks/2', data=json.dumps({'completed': True}), content_type='application/json')
